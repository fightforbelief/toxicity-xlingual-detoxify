...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--config",
        type=str,
        default="configs/hard_sample_config.yaml",
    ...
    parser.add_argument(
        ...
        type=str,
        default="hard_sample",
        help="Prefix of prediction files, e.g. 'hard_sample' for hard_sample_en.csv.",
    )
    parser.add_argument(
        "--languages",
        type=str,
    ...
    parser.add_argument(
        "--output",
        type=str,
        default="output/predictions/hard_sample_metrics.csv",
